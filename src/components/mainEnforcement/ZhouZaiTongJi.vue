<template>
  <div class="main-panel-wrap ZhouZaiTongJi2-wrap">
    ...
    <div class="main-panel-body">
      ...
      <div id="ZhouZaiTongJi2_charts"></div>
    </div>
  </div>
</template>
<script>
  export default {
    ...
    methods: {
      ...
      initChart () {
        let myChart = this.$echarts.init(document.getElementById('ZhouZaiTongJi2_charts'))
