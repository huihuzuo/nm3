<template>
  <div class="sf-road-state-content">
    <ul>
      <li class="msg">
        <span>实时路况</span><span>（更新时间：{{time}}）</span>
        <span class="el-icon-close closeCondition" @click="closefunc_()"></span>
      </li>
      <li class="line-bar">
        <div title="V<40"><span class="color fir"></span><span class="text">严重拥堵</span></div>
        <div title="40<= V<60"><span class="color sec"></span><span class="text">拥挤</span></div>
        <div title="V>=60"><span class="color th"></span><span class="text">缓行</span></div>
        <div><span class="color for"></span><span class="text">畅通</span></div>
      </li>
    </ul>
  </div>
</template>
