<template>
  <div class="arrow-wrap">
    <div class="arrow-left-top-wrap">
    </div>
    <div class="arrow-wrap-top-header">
      <span>详情</span>
...
<style lang="scss">
  ...
  .arrow-wrap{
    ...
    .arrow-left-top-wrap{
      ...
      background-color: #FFF;
      box-shadow:
        -1px 0 0 rgba(13, 5, 9, 0.15), 0 -1px 0 rgba(13, 5, 9, 0.15), 0 -2px 0 rgba(13, 5, 9, 0), 0 -2px 0 rgba(13, 5, 9, 0)

      // box-shadow: 1px 1px 4px 1px rgba(0, 0, 0, 0.15);
    }
    .arrow-wrap-top-header{
      width: 100%;
      height: 34px;
      line-height: 34px;
      color: #1a82ee;
