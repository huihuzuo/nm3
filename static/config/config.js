var config = {
  ...
  service: {
    ...
    settingWeatherUrl: 'http://192.168.0.121:7072',
    settingTrafficUrl: 'http://192.168.0.121:7702',
    settingEventUrl: 'http://192.168.0.121:7605',
    geocoding: 'http://211.101.37.227:9320/',
    basicUrl: 'http://192.168.0.216:8804/',
    baiduTrafficUrl:'http://192.168.0.216:7702/traffic/',  //百度路况
    weatherUrl: 'nm-waio-weather-rest/',  //气象
    gaodeEventUrl: 'event-gaode-spider/',
    gaodeTrafficUrl: 'nm-traffic-gaode-spider/',  //高德路况
    LuwanEventStatisticUrl: 'nm-rnmonitor-service2/',//路网事件的上半部分数据
    LuwanEventListUrl : 'nm-rnmonitor-service2', //路网事件的下半部分数据
    HulianwangEventListUrl: 'nm-event-gaode-spider/', //互联网下半部分数据
    JiaodiaozhanTrafficUrl: 'http://192.168.0.216:7605/',//交调站static baseurl
    JiaodiaozhanTrafficListUrl: 'nm-rnmonitor-service2/',

    geocoding:'http://192.168.0.216:7602/',
    //geocoding: 'http://211.101.37.227:9320/',
